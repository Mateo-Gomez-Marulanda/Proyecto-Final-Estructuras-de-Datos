...
public class ClientCatalogController {
    ...
    @FXML
    private TableColumn<Property, String> colZona;
    @FXML
    ...
    @FXML
    private ComboBox<String> filtroOrden;
    ...
    public void verDetalles() {
        ...
        if (p.isAvailable()) {
            lblEstadoBadge.setStyle(
                    "-fx-background-color: #dcfce7; -fx-text-fill: #15803d; -fx-font-weight: bold; -fx-background-radius: 4; -fx-font-size: 11px;");
        } else {
            lblEstadoBadge.setStyle(
                    "-fx-background-color: #fee2e2; -fx-text-fill: #b91c1c; -fx-font-weight: bold; -fx-background-radius: 4; -fx-font-size: 11px;");
        }
