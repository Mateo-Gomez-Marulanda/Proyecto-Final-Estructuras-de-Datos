...
public class AppContext {
    ...
    // Getters
    public SimpleLinkedList<Contract> getContracts() {
        return contracts;
    }
    ...
    public SimpleLinkedList<Advisor> getAdvisors() {
        return advisors;
    }

    public ObservableList<BusinessOperation> getOperations() {
        return operations;
    }

    public Queue<Alert> getPendingAlerts() {
        return pendingAlerts;
    }

    public SimpleLinkedList<Alert> getAlertHistory() {
        return alertHistory;
    }
    ...
    private void crearAdminSiNoExiste() {
        if (clientManager.getClientTable().get("admin") != null)
            return;
