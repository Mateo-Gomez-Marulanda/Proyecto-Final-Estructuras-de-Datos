...
public class ReportesController {
    ...
    public void initialize() {
        // 1. se elimina la carga automática para proteger el rendimiento de las
        // estructuras de datos.
        // 2. estilo de fuente monoespaciada para que las tablas de texto plano
     ...
     * y los inyecta en el área de texto. Este método debe estar enlazado a tu botón
     * de la UI (onAction).
     */
    @FXML
    public void generarReporte() {
        try {
            // Un pequeño feedback visual para que el usuario sepa que el sistema está
            // trabajando
    ...
    /**
     * Limpia el área de texto. También lo puedes dejar mapeado a un botón de
     * "Limpiar".
     */
    @FXML
